...
GREEN_BOX = (200, 100)
BLUE_BOX = (350, 100)
RESET_BOX = (500, 100, 80, 80)  # x, y, w, h
    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Check if finger is inside RED box
        ...
        # Fill current color level
        cv2.rectangle(img, (RED_BOX[0], RED_BOX[1]), (RED_BOX[0] + BOX_WIDTH, RED_BOX[1] + int((RGB_Values[0] / 255) * BOX_HEIGHT)), (0, 0, 255), -1)
        cv2.rectangle(img, (GREEN_BOX[0], GREEN_BOX[1]), (GREEN_BOX[0] + BOX_WIDTH, GREEN_BOX[1] + int((RGB_Values[1] / 255) * BOX_HEIGHT)), (0, 255, 0), -1)
        cv2.rectangle(img, (BLUE_BOX[0], BLUE_BOX[1]), (BLUE_BOX[0] + BOX_WIDTH, BLUE_BOX[1] + int((RGB_Values[2] / 255) * BOX_HEIGHT)), (255, 0, 0), -1)

        # Reset button
        cv2.rectangle(img, (RESET_BOX[0], RESET_BOX[1]), (RESET_BOX[0] + RESET_BOX[2], RESET_BOX[1] + RESET_BOX[3]), (0, 255, 255), 2)
        cv2.putText(img, "RESET", (RESET_BOX[0]+5, RESET_BOX[1]+50), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)

        # Show RGB values
        cv2.putText(img, f"R:{RGB_Values[0]} G:{RGB_Values[1]} B:{RGB_Values[2]}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
